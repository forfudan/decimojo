"""
Comprehensive tests for the log10() function of the Decimal type.
...
fn test_edge_cases() raises:
    ...
    var val5 = Decimal("0." + "0" * 19 + "1")  # 10^-20
    var result5 = val5.log10()
    testing.assert_equal(
        String(result5),
        "-20",
...
fn test_precision() raises:
    ...
    var val1 = Decimal("3.14159265358979323846")
    var result1 = val1.log10()
    testing.assert_true(
    ...
    var result3 = val3.log10()
    testing.assert_true(
        abs(result3 - Decimal("0.301029995663981"))
...
fn test_mathematical_properties() raises:
    ...
    var n_times_log3 = Decimal(n3) * a3.log10()
    testing.assert_true(
...
fn test_consistency_with_other_logarithms() raises:
    ...
    var ln_val1 = val1.ln()
    var ln_10 = Decimal(10).ln()
    var ln_ratio1 = ln_val1 / ln_10
    testing.assert_true(
        abs(log10_val1 - ln_ratio1) < Decimal("0.000000000001"),
    ...
    var log_base10_val2 = val2.log(Decimal(10))
    testing.assert_true(
        abs(log10_val2 - log_base10_val2) < Decimal("0.000000000001"),
