"""
Comprehensive tests for the Decimal.from_int() method.
Tests various scenarios to ensure proper conversion from integer values to Decimal.
"""
...
fn test_basic_integers() raises:
    ...
    # Test case 1: Zero
    var result1 = Decimal.from_int(0)
    ...
    var result2 = Decimal.from_int(123)
    testing.assert_equal(
        String(result2),
        "123",
    ...
    var result3 = Decimal.from_int(-456)
    testing.assert_equal(
        String(result3),
        "-456",
    ...
    var a = Decimal.from_int(10)
    var b = Decimal.from_int(5)
    var sum_result = a + b
    testing.assert_equal(
        String(sum_result),
        "15",
...
fn test_large_integers() raises:
    ...
    var large_pos = Decimal.from_int(1000000000)  # 1 billion
    testing.assert_equal(
        String(large_pos),
        "1000000000",
    ...
    var large_neg = Decimal.from_int(-2000000000)  # -2 billion
    testing.assert_equal(
        String(large_neg),
        "-2000000000",
    ...
    var int32_max = Decimal.from_int(2147483647)  # 2^31 - 1
    testing.assert_equal(
        String(int32_max),
        "2147483647",
    ...
    var int32_min = Decimal.from_int(-2147483648)  # -2^31
    testing.assert_equal(
        String(int32_min),
        "-2147483648",
    ...
    var very_large = Decimal.from_int(9223372036854775807)  # 2^63 - 1
    testing.assert_equal(
        String(very_large),
        "9223372036854775807",
...
fn test_operations_with_from_int() raises:
    ...
    var a1 = Decimal.from_int(100)
    var b1 = Decimal.from_int(50)
    var result1 = a1 + b1
    testing.assert_equal(
    ...
    var a2 = Decimal.from_int(100)
    var b2 = Decimal.from_int(30)
    var result2 = a2 - b2
    testing.assert_equal(
    ...
    var a3 = Decimal.from_int(25)
    var b3 = Decimal.from_int(4)
    var result3 = a3 * b3
    testing.assert_equal(
    ...
    var a4 = Decimal.from_int(100)
    var b4 = Decimal.from_int(5)
    var result4 = a4 / b4
    testing.assert_equal(
    ...
    var a5 = Decimal.from_int(10)
    var b5 = Decimal("3.5")  # String constructor
    var result5 = a5 * b5
    testing.assert_equal(
        String(result5),
        "35.0",
...
fn test_comparison_with_from_int() raises:
    ...
    var a1 = Decimal.from_int(100)
    var b1 = Decimal.from_int(100)
    testing.assert_true(a1 == b1, "from_int(100) should equal from_int(100)")

    # Test case 2: Equality with string constructor
    var a2 = Decimal.from_int(123)
    var b2 = Decimal("123")
    testing.assert_true(a2 == b2, "from_int(123) should equal Decimal('123')")

    # Test case 3: Less than
    var a3 = Decimal.from_int(50)
    var b3 = Decimal.from_int(100)
    testing.assert_true(
        a3 < b3, "from_int(50) should be less than from_int(100)"
    )

    # Test case 4: Greater than
    var a4 = Decimal.from_int(200)
    var b4 = Decimal.from_int(100)
    testing.assert_true(
        a4 > b4, "from_int(200) should be greater than from_int(100)"
    )

    # Test case 5: Equality with negative values
    var a5 = Decimal.from_int(-500)
    var b5 = Decimal("-500")
    testing.assert_true(a5 == b5, "from_int(-500) should equal Decimal('-500')")
...
fn test_edge_cases() raises:
    ...
    var neg_zero = -0
    var dec_neg_zero = Decimal.from_int(neg_zero)
    var is_neg_zero = dec_neg_zero.is_negative() and dec_neg_zero.is_zero()
    testing.assert_equal(
        is_neg_zero,
        False,
        "Negative zero should not preserve negative sign in Decimal",
    )

    # Test case 3: INT64_MIN
    # Note: Most extreme negative value representable in Int
    var int64_min = Decimal.from_int(-9223372036854775807 - 1)
    testing.assert_equal(
        String(int64_min),
        "-9223372036854775808",
    ...
    var from_int_val = Decimal.from_int(12345)
    var from_string_val = Decimal("12345")
    testing.assert_true(
    ...
    var power10 = Decimal.from_int(10**9)  # 1 billion
...
fn test_from_int_with_scale() raises:
    ...
    var result1 = Decimal.from_int(123, 2)
    testing.assert_equal(
        String(result1),
        "1.23",
    ...
    var result2 = Decimal.from_int(-456, 3)
    testing.assert_equal(
        String(result2),
        "-0.456",
    ...
    var result3 = Decimal.from_int(0, 4)
    testing.assert_equal(
        String(result3),
        "0.0000",
    ...
    var result4 = Decimal.from_int(123, 2)
    testing.assert_equal(
        String(result4),
        "1.23",
    ...
    var result5 = Decimal.from_int(1, 25)
    testing.assert_equal(
        String(result5),
    ...
    var result6 = Decimal.from_int(1, Decimal.MAX_SCALE)
    testing.assert_equal(
        result6.scale(),
        Decimal.MAX_SCALE,
        "Scale should be set to MAX_SCALE = " + String(Decimal.MAX_SCALE),
    )

    # Test case 7: Arithmetic with scaled value
    var a7 = Decimal.from_int(10, 1)  # 1.0
    var b7 = Decimal.from_int(3, 2)  # 0.03
    var result7 = a7 / b7
    testing.assert_equal(
        String(result7),
    ...
    var a8 = Decimal.from_int(123, 0)  # 123
    var b8 = Decimal.from_int(123, 2)  # 1.23
    testing.assert_true(
...
fn main() raises:
    print("=========================================")
    print("Running Decimal.from_int() Tests")
    print("=========================================")
    ...
    print("All Decimal.from_int() tests passed!")
