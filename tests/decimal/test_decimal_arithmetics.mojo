...
fn test_add() raises:
    ...
    var a1 = Decimal(12345, scale=2)  # 123.45
    var b1 = Decimal(6789, scale=2)  # 67.89
    var result1 = a1 + b1
    ...
    var a2 = Decimal(1234, scale=1)
    var b2 = Decimal(6789, scale=2)
    var result2 = a2 + b2
    testing.assert_equal(
    ...
    var a3 = Decimal(12345, scale=2)
    var b3 = Decimal(-6789, scale=2)
    var result3 = a3 + b3
    testing.assert_equal(
    ...
    var a4 = Decimal(-12345, scale=2)
    var b4 = Decimal(6789, scale=2)
    var result4 = a4 + b4
    testing.assert_equal(
    ...
    var a8 = Decimal(1, scale=6)
    var b8 = Decimal(2, scale=7)
    var result8 = a8 + b8
    testing.assert_equal(
    ...
    var a9 = Decimal.from_uint128(123456789012345678901234567, scale=27)
    var b9 = Decimal.from_uint128(987654321098765432109876543, scale=27)
    var result9 = a9 + b9
    testing.assert_equal(
        String(result9),
    ...
    var b10 = Decimal(123456789, scale=18)  # 0.000000000123456789
    ...
    var a11 = Decimal.from_uint128(
        UInt128(1111111111111111111111111111), scale=28
    )  # 0.1111...1 (28 digits)
    var b11 = Decimal.from_uint128(
    ...
    var a12 = Decimal.from_uint128(
        UInt128(1111111111111111111111111111), scale=28
    )  # 0.1111...1 (28 digits)
    var b12 = Decimal.from_uint128(
    ...
    var a13 = Decimal(1, scale=28)  # 0.0000...01 (1 at 28th place)
    var b13 = Decimal(2, scale=28)  # 0.0000...02 (2 at 28th place)
    ...
    var a14 = Decimal(101, 2)
    var b14 = Decimal(-101, 3)
    ...
    var a17 = Decimal.from_uint128(12345678901234567890123456789, scale=10)
    var b17 = Decimal(9876543211, scale=28)
    ...
    var a18 = Decimal.from_uint128(
        UInt128(45631171710880163026696499898), scale=13
    )
    var b18 = Decimal(0, scale=28)
...
fn test_negation() raises:
    ...
    var a6 = Decimal(1, scale=28)  # 0.0000...01 (1 at 28th place)
    var result6 = -a6
    testing.assert_equal(
...
fn test_subtract() raises:
    ...
    var a2 = Decimal(1234, 1)
    var b2 = Decimal(6789, 2)
    var result2 = a2 - b2
    testing.assert_equal(
    ...
    var a9 = Decimal(10000001, 7)
    var b9 = Decimal(10000000, 7)
    var result9 = a9 - b9
    testing.assert_equal(
    ...
    var a12a = Decimal(123456, 3)
    var b12a = Decimal(789012, 3)
