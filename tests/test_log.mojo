"""
Comprehensive tests for the log() function of the Decimal type.
...
fn test_basic_log() raises:
    ...
    var val4 = Decimal(1000)
    var base4 = Decimal(10)
...
fn test_fractional_inputs() raises:
    ...
    var val4 = Decimal("0.001")
    var base4 = Decimal("0.1")
    var result4 = val4.log(base4)
    testing.assert_equal(
    ...
    var val5 = Decimal("1.5")
    var base5 = Decimal("2.5")
    var result5 = val5.log(base5)
    testing.assert_true(
...
fn test_edge_cases() raises:
    ...
    var val6 = Decimal(1)
    var base6 = Decimal(7.5)  # Any base should give result 0
...
fn test_precision() raises:
    ...
    var val3a = Decimal("1.000001")
    var val3b = Decimal("1.000002")
    var base3 = Decimal(10)
...
fn test_mathematical_properties() raises:
    ...
    testing.assert_true(
        abs(log_product1 - sum_logs1) < Decimal("0.000000000001"),
    ...
    testing.assert_true(
        abs(log_quotient2 - diff_logs2) < Decimal("0.000000000001"),
        "log_a(x/y) should equal log_a(x) - log_a(y)",
    )
    ...
    var n_times_log3 = Decimal(n3) * x3.log(a3)
    testing.assert_true(
        abs(log_power3 - n_times_log3) < Decimal("0.000000000001"),
    ...
    var x4 = Decimal(7)
    var a4 = Decimal(3)
    var log_inverse4 = (Decimal(1) / x4).log(a4)
    var neg_log4 = -x4.log(a4)
    testing.assert_true(
        abs(log_inverse4 - neg_log4) < Decimal("0.000000000001"),
    ...
    var b5 = Decimal(7)
    var a5 = Decimal(3)
    var c5 = Decimal(10)  # Arbitrary third base
    var direct_log5 = b5.log(a5)
    var change_base5 = b5.log(c5) / a5.log(c5)
    testing.assert_true(
        abs(direct_log5 - change_base5) < Decimal("0.000000000001"),
...
fn test_consistency_with_other_logarithms() raises:
    ...
    var val1 = Decimal(7)
    var log_base10_val1 = val1.log(Decimal(10))
    var log10_val1 = val1.log10()
    testing.assert_true(
        abs(log_base10_val1 - log10_val1) < Decimal("0.000000000001"),
        "log(x, 10) should equal log10(x)",
    )

    # Test case 2: log_e(x) == ln(x)
    var val2 = Decimal(5)
    var log_base_e_val2 = val2.log(Decimal.E())
    var ln_val2 = val2.ln()
    testing.assert_true(
        abs(log_base_e_val2 - ln_val2) < Decimal("0.000000000001"),
