...
fn test_fractional_exponents() raises:
    ...
    # Test case 3: e^(-0.5)
    var neg_half = Decimal(String("-0.5"))
    ...
    # Test case 4: e^1.5
    var one_half = Decimal(String("1.5"))
...
fn test_high_precision_exponents() raises:
    ...
    var pi = Decimal(String("3.14159265358979323846264338327950288"))
    var result1 = exp(pi)
    var expected1 = String(
    ...
    var approx_e = Decimal(String("2.71828"))
...
fn test_mathematical_identities() raises:
    ...
    var a = Decimal(String("2"))
    var b = Decimal(String("3"))
...
fn test_extreme_values() raises:
    ...
    var small_input = Decimal(String("0.0000001"))
    ...
    var small_neg_input = Decimal(String("-0.0000001"))
    ...
    var large_input = Decimal(String("20"))
    var result3 = exp(large_input)
    testing.assert_true(
        result3 > Decimal(String("100000000")),
...
fn test_edge_cases() raises:
    ...
    var high_precision = Decimal(String("1.23456789012345678901234567"))
