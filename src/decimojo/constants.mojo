...
fn INV10() -> Decimal:
    """Returns 1/10 = 0.1."""
    return Decimal(0x1, 0x0, 0x0, 0x10000)
...
fn INV0D3() -> Decimal:
    ...
    return Decimal(0x35555555, 0xCF2607EE, 0x6BB4AFE4, 0x1C0000)


@always_inline
fn INV0D4() -> Decimal:
    """Returns 1/0.4 = 2.5."""
    return Decimal(0x19, 0x0, 0x0, 0x10000)
...
fn INV0D6() -> Decimal:
    ...
    return Decimal(0x1AAAAAAB, 0x679303F7, 0x35DA57F2, 0x1C0000)


@always_inline
fn INV0D7() -> Decimal:
    """Returns 1/0.7 = 1.42857142857142857142857142857143..."""
    return Decimal(0xCDB6DB6E, 0x3434DED3, 0x2E28DDAB, 0x1C0000)


@always_inline
fn INV0D8() -> Decimal:
    """Returns 1/0.8 = 1.25."""
    return Decimal(0x7D, 0x0, 0x0, 0x20000)


@always_inline
fn INV0D9() -> Decimal:
    """Returns 1/0.9 = 1.11111111111111111111111111111111..."""
    return Decimal(0x671C71C7, 0x450CAD4F, 0x23E6E54C, 0x1C0000)
...
fn INV1D3() -> Decimal:
    ...
    return Decimal(0xC4EC4EC, 0x9243DA72, 0x18DAED83, 0x1C0000)


@always_inline
fn INV1D4() -> Decimal:
    """Returns 1/1.4 = 0.71428571428571428571428571428571..."""
    return Decimal(0xE6DB6DB7, 0x9A1A6F69, 0x17146ED5, 0x1C0000)
...
fn INV1D6() -> Decimal:
    """Returns 1/1.6 = 0.625."""
    return Decimal(0x271, 0x0, 0x0, 0x30000)


@always_inline
fn INV1D7() -> Decimal:
    """Returns 1/1.7 = 0.58823529411764705882352941176471..."""
    return Decimal(0x45A5A5A6, 0xE8520166, 0x1301C4AF, 0x1C0000)


@always_inline
fn INV1D8() -> Decimal:
    """Returns 1/1.8 = 0.55555555555555555555555555555556..."""
    return Decimal(0xB38E38E4, 0x228656A7, 0x11F372A6, 0x1C0000)
