...
1. Using direct meory access would require unsafe pointer manipulation, breaking DeciMojo's current design principles of using safe Mojo as much as possible.
