"""Benchmarks for BigDecimal multiplication. Compares against Python decimal."""
...
fn main() raises:
    ...
    print_header("DeciMojo BigDecimal Multiplication Benchmark", log_file)
    ...
    print_summary(
        "BigDecimal Multiplication Benchmark Summary",
        sf,
        "BigDecimal",
        iterations,
        log_file,
