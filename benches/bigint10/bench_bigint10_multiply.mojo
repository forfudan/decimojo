"""Benchmarks for BigInt10 multiplication. Compares BigInt10, BigInt2, and Python int."""
...
fn main() raises:
    ...
    var log_file = open_log_file("benchmark_bigint10_multiply")
    print_header("DeciMojo BigInt10 Multiplication Benchmark", log_file)
    ...
    print_summary_dual(
        "BigInt10 Multiplication Benchmark Summary",
        sf1,
        "BigInt10",
        sf2,
        "BigInt2",
