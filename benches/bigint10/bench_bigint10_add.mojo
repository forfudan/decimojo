"""Benchmarks for BigInt10 addition. Compares BigInt10, BigInt2, and Python int."""
...
fn main() raises:
    ...
    print_header("DeciMojo BigInt10 Addition Benchmark", log_file)
    ...
    print_summary_dual(
        "BigInt10 Addition Benchmark Summary",
        sf1,
        "BigInt10",
        sf2,
        "BigInt2",
