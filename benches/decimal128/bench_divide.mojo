"""Benchmarks for Decimal128 division. Compares against Python decimal."""
...
fn main() raises:
    ...
    print_header("DeciMojo Decimal128 Division Benchmark", log_file)
    ...
    print_summary(
        "Decimal128 Division Benchmark Summary",
        sf,
        "Decimal128",
        iterations,
        log_file,
