...
fn run_benchmark_quantize(
    ...
    if rounding_mode == materialize[RoundingMode.ROUND_HALF_EVEN]():
        py_rounding_mode = pydecimal.ROUND_HALF_EVEN
    elif rounding_mode == materialize[RoundingMode.ROUND_HALF_UP]():
        py_rounding_mode = pydecimal.ROUND_HALF_UP
    elif rounding_mode == materialize[RoundingMode.ROUND_UP]():
        py_rounding_mode = pydecimal.ROUND_UP
    elif rounding_mode == materialize[RoundingMode.ROUND_DOWN]():
