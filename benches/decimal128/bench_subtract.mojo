"""Benchmarks for Decimal128 subtraction. Compares against Python decimal."""
...
fn main() raises:
    ...
    print_header("DeciMojo Decimal128 Subtraction Benchmark", log_file)
    ...
    print_summary(
        "Decimal128 Subtraction Benchmark Summary",
        sf,
        "Decimal128",
        iterations,
        log_file,
