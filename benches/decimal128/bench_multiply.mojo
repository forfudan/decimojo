"""Benchmarks for Decimal128 multiplication. Compares against Python decimal."""
...
fn main() raises:
    ...
    print_header("DeciMojo Decimal128 Multiplication Benchmark", log_file)
    ...
    print_summary(
        "Decimal128 Multiplication Benchmark Summary",
        sf,
        "Decimal128",
        iterations,
        log_file,
