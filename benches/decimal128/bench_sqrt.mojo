"""Benchmarks for Decimal128 sqrt() function. Compares against Python decimal."""
...
fn main() raises:
    ...
    print_header("DeciMojo Decimal128 Square Root Benchmark", log_file)
    ...
    print_summary(
        "Decimal128 Square Root Benchmark Summary",
        sf,
        "Decimal128",
        iterations,
        log_file,
