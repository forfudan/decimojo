"""Benchmarks for Decimal128 from-float construction. Compares against Python decimal."""
...
fn run_case(
    ...
    var fval = Float64(atof(bc.a))
    var py_float = py_builtins.float(bc.a)

    try:
        var rm = Decimal128(fval)
        var rp = pydecimal.Decimal(py_float)
...
fn main() raises:
    ...
    print_header("DeciMojo Decimal128 From-Float Benchmark", log_file)

    var pydecimal = Python.import_module("decimal")
    pydecimal.getcontext().prec = 28
    var py_builtins = Python.import_module("builtins")

    var cases = load_bench_cases("bench_data/from_float.toml")
    ...
    print_summary(
        "Decimal128 From-Float Benchmark Summary",
        sf,
        "Decimal128",
        iterations,
        log_file,
