"""Benchmarks for Decimal128 modulo (%). Compares against Python decimal."""
...
fn main() raises:
    ...
    print_header("DeciMojo Decimal128 Modulo Benchmark", log_file)

    var pydecimal = Python.import_module("decimal")
    pydecimal.getcontext().prec = 28

    var cases = load_bench_cases("bench_data/modulo.toml")
    ...
    print_summary(
        "Decimal128 Modulo Benchmark Summary",
        sf,
        "Decimal128",
        iterations,
        log_file,
