"""Benchmarks for Decimal128 ln() function. Compares against Python decimal."""
...
fn main() raises:
    ...
    print_header("DeciMojo Decimal128 Natural Logarithm Benchmark", log_file)
    ...
    print_summary(
        "Decimal128 Natural Logarithm Benchmark Summary",
        sf,
        "Decimal128",
        iterations,
        log_file,
