"""Benchmarks for Decimal128 log10() function. Compares against Python decimal."""
...
fn main() raises:
    ...
    print_header("DeciMojo Decimal128 log10 Benchmark", log_file)

    var pydecimal = Python.import_module("decimal")
    pydecimal.getcontext().prec = 28

    var cases = load_bench_cases("bench_data/log10.toml")
    var iterations = 100
    var sf = List[Float64]()
    ...
    print_summary(
        "Decimal128 log10 Benchmark Summary",
        sf,
        "Decimal128",
        iterations,
        log_file,
