"""Benchmarks for Decimal128 floor division (//). Compares against Python decimal."""
...
fn main() raises:
    ...
    print_header("DeciMojo Decimal128 Floor Division Benchmark", log_file)
    ...
    print_summary(
        "Decimal128 Floor Division Benchmark Summary",
        sf,
        "Decimal128",
        iterations,
        log_file,
