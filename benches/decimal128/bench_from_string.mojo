"""Benchmarks for Decimal128 from-string construction. Compares against Python decimal."""
...
fn run_case(
    ...
    try:
        var rm = Decimal128(str_val)
        var rp = pydecimal.Decimal(str_val)
...
fn main() raises:
    ...
    print_header("DeciMojo Decimal128 From-String Benchmark", log_file)
    ...
    print_summary(
        "Decimal128 From-String Benchmark Summary",
        sf,
        "Decimal128",
        iterations,
        log_file,
