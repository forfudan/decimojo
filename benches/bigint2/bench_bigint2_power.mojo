"""Benchmarks for BigInt2 exponentiation. Compares BigInt, BigInt2, and Python int."""
...
fn run_case(
    ...
    var m1_base = BigInt(bc.a)
    var base = BigInt2(bc.a)
    var exp_int = Int(BigInt2(bc.b))
...
fn main() raises:
    ...
    var log_file = open_log_file("benchmark_bigint2_power")
    print_header("DeciMojo BigInt2 Power Benchmark", log_file)
    ...
    print_summary_dual(
        "BigInt2 Power Benchmark Summary",
        sf1,
        "BigInt",
        sf2,
        "BigInt2",
