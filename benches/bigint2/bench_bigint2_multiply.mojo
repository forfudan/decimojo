"""Benchmarks for BigInt2 multiplication. Compares BigInt10, BigInt2, and Python int."""
...
fn main() raises:
    ...
    var log_file = open_log_file("benchmark_bigint2_multiply")
    print_header("DeciMojo BigInt2 Multiplication Benchmark", log_file)
    ...
    print_summary_dual(
        "BigInt2 Multiplication Benchmark Summary",
        sf1,
        "BigInt10",
        sf2,
        "BigInt2",
